...
Motherboard::Motherboard() :
	...
	lcd(LCD_RS_PIN, LCD_RW_PIN, LCD_ENABLE_PIN,LCD_D0_PIN,LCD_D1_PIN,LCD_D2_PIN,LCD_D3_PIN),
	...
	Extruder_One(0, EX1_PWR, EX1_FAN, EXTRUDER_THERMISTOR_PIN, eeprom_offsets::T0_DATA_BASE),
	Extruder_Two(1, EX2_PWR, EX2_FAN, EXTRUDER2_THERMISTOR_PIN, eeprom_offsets::T1_DATA_BASE)
...
void Motherboard::init() {
	...
	//Sets if an interface board is present from the config
	//This used to use a PIN to detect if an interface was present but doesn't seem needed
	hasInterfaceBoard = HAS_INTERFACE_BOARD;
