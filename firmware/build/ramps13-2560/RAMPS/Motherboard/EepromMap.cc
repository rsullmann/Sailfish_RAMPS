...
void factoryResetEEPROM() {
	...
	uint8_t home_direction = 0b10111; // X Max, Y Min, Z Max  (AB max - to never halt on edge in stepper interface)

	uint8_t vRefBase[] = {118,118,118,118,118};  //(AB maxed out)
